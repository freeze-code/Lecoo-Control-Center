use ipc::{ChargeLimit, FanIndex, FanMode, IpcResponse, KeyboardBacklightLevel, PowerProfile};
...
pub fn set_charge_limit(_ec: &EcDevice, _limit: &ChargeLimit) -> Result<IpcResponse> {
